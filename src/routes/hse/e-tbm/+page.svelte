...
<div class="project-box">
	<form action="" class="forms">
		...
		<div class="upload">
			<p class="upload-text">
				<input type="file" id="tbm_form" name="tbm_form" accept="image/png, image/jpeg" />
			</p>
		</div>
		...
		<div class="upload">
			<p class="upload-text">
				<input type="file" id="tbm_photo" name="tbm_photo" accept="image/png, image/jpeg" />
			</p>
		</div>
		<h2 class="heading">Photo of Filled PTW Form</h2>
		<div class="upload">
			<p class="upload-text">
				<input type="file" id="ptw_form" name="ptw_form" accept="image/png, image/jpeg" />
			</p>
		</div>
