...
<div class="project-box">
    <form action="" class="forms">
        ...
        <div class="upload">
            <p class="upload-text"><input type="file" id="ppe_photo" name="ppe_photo" accept="image/png, image/jpeg" /></p>
        </div>
        <br><hr>
        <h2 class="heading">Report for the Day</h2>
        <div class="report-type">
            <label for="sitewalk-count" class="report-label"><b>No. of Site Walk:</b></label>
            <input type="text" class="report-count">
        </div>
        <div class="report-type">
        ...
        <div class="report-type">
            <label for="uauc-count" class="report-label"><b>No. Unsafe Act Unsafe Condition (UAUC):</b></label>
            <input type="text" class="report-count">
        </div>
        <div class="report-type">
        ...
        <div class="report-type">
            <label for="nlti-count" class="report-label">(ii) No. of Accidents (No Lost Time Injuries):</label>
            <input type="text" class="report-count">
        </div>
        <p><b>(B) Non-Injuries</b></p>
        <div class="report-type">
            <label for="opd-count" class="report-label">(i) No. of Established Occupational Poisoning or Disease (OPD):</label>
            <input type="text" class="report-count">
        </div>
        <div class="report-type">
        ...
        <div class="report-type">
            <label for="sodo-count" class="report-label"><b>(C) No. of Significant Safety Occurrence / Dangerous Occurrence:</b></label>
            <input type="text" class="report-count">
        </div>
        <hr>
        <h2 class="heading">Remarks</h2>
        <p><textarea name="" id="" cols="30" rows="10" class="remarks" placeholder="Remarks"></textarea></p>
        <p class="note">For any case reported above, please attached the Incident Reporting Form which can be obtained  <a href="https://boilermechhr.com/databases/intranet-employee-view?open-modal=3712&resource=intranet-employee-view">here</a>.</p>
